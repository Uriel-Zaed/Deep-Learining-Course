...
if __name__ == '__main__':
    ...
    num_of_epochs = 100
    learning_rate = 0.1
    max_lr = 0.1  # Max learning rate for the One-Cycle policy
    ...
    total_steps = num_of_epochs * len(trainloader)  # Total steps for the scheduler
    ...
    # Update the learning rate scheduler with the best hyperparameters
    optimizer = optim.SGD(model.parameters(), lr=learning_rate, momentum=0.9)
    scheduler = OneCycleLR(optimizer, max_lr=learning_rate, total_steps=restart_epoch,
